...
# ⚠️ قاعدة ذهبية هنا: الكلمة اللي ممكن تطلع من **عميل بيشتري** ممنوعة.
# اتشالت "خصم" و"تخفيض" لأنهم إشارة شراء مش اعتراض — الإعلانات نفسها بتقول
# "بعد الخصم"، فسؤال "كم السعر بعد الخصم؟" كان بيتسجّل اعتراض من أول رسالة.
# واتشالت "لسه" لأنها كلمة يومية عادية ("لسه بسأل"، "لسه شايف").
# واتشالت "نصاب/نصب" من هنا لأنها اتهام (موجودة أصلاً في قائمة الشكاوى)
# مش تردد، وكانت بتخلي شكوى تتسجّل اعتراض كمان.
OBJECTION_KEYWORDS = {
    "objection_expensive": [
        "غالي", "غاليه", "غالى", "غالية", "كتير عليا", "كتير أوي", "كتير علي",
        "مبالغ", "سعره كبير", "السعر كبير", "مش قد كده", "مش قد حالي",
        "في أرخص", "فيه أرخص", "ارخص", "أرخص", "مفيش أقل", "في أقل",
        "معنديش المبلغ", "ما معي المبلغ", "فوق ميزانيتي",
    ],
    "objection_unsure": [
        "مش متأكد", "مش متاكد", "مو متأكد", "مش واثق", "خايف", "خايفه",
        "قلقان", "هل بجد", "بجد بيجيب نتيجة", "مش مضمون", "مو مضمون",
        "مش مقتنع", "مو مقتنع", "محتار", "محتارة", "مش عارف أقرر",
    ],
    "objection_later": [
        "بعدين", "هفكر", "افكر", "أفكر", "بفكر", "رح فكر", "لما أشوف",
        "مش دلوقتي", "مو هلق", "هرجع لك", "هرجعلك", "برجعلك",
        "أستأذن", "هشوف وأرد", "مش وقته", "مش وقتها",
    ],
}
